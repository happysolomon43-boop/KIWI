...
// BUG-4 FIX: also update global KS so knowledge_score_global never stays at 0
...
// Wire streak_danger emails: users with active streak who haven't studied today
try {
const today = new Date().toISOString().slice(0, 10);
const allUsersForStreak = await db.users.findAll();
let dangerSent = 0;
